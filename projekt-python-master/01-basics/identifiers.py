...
# global = 1 - nesmi obsahovat kličová slova
Global = 1
...
# hilda@sspu-opava.cz = 'Hilda Dokonalá' - nesmí obsahovat speciální znaky
hildasspuopava = 'Hilda Dokonalá'

password2 = 'TajneHeslo'

# 007agent = 'James Bond' - nesmí obsahovat čísla na začátku
agent07 = "James Bond"
